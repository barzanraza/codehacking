...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{asset('css/app.css')}}" rel="stylesheet"> {{-- asset() function eka la folderi public badway aw shtana agaret ka to nusewta  --}}
